...
describe('numberToDollars', function() {
    ...
    it('should return "One billion two hundred thirty-four million five hundred sixty-seven thousand eight hundred ninety and 00/100 dollars" when passing 1234567890', function(){
        var result = numberToDollars(1234567890);
        expect(result).toEqual('One billion two hundred thirty-four million five hundred sixty-seven thousand eight hundred ninety and 00/100 dollars');
    });
});